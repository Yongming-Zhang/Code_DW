    ...
    if len(plaque_num) != 0:
        if len(plaque2vessel_num) > len(vessel_num) or len(plaque2vessel_num) > 1:
            for i in range(1, len(plaque2vessel_num)):
                if plaque2vessel_volume[i] > 100:
                    ...
                    #    plaque_arr[out_plaque_data==plaque_num[p]] = 10 
                        #计算该连通域和每个斑块的距离，满足最小距离小于3＊＊0.5＋0.00001的就是相邻斑块，从而确定plaque_num[p]值 
            ...
            if flag:
                ...
                vessel_data[vessel_data==2] = 1
                data_label_area, out_data = mark_component(vessel_data)
...
broken_vessels = ['1036604_60_0416', '1036623', '1073309', '1073332', '1073330', '1073318', '1036617']#['1036623', '1073309', '1073332', '1073330', '1073318', '1036617'] #[1036604_60_0416]
