...
def cpr2cta_map_direct(cpr_coords, cpr_mask_data, cta_shape, cpr_map_index, patient, series, mask_names, contour_files, cpr_centerlines):
    ...
    for cout in range(len(cpr_centerlines)):
        ...
        for i in range(cpr_counts*20, (cpr_counts+1)*20):
            ...
            #if i%20 == 4:
            #    break
        dices = cta2cpr(cpr_coords, cta_data, cpr_map_index, patient, series, mask_names, cpr_counts)
...
name_list = ['1036604']#['1036602', '1036604', '1036607', '1036631', '1036632', '1036610', '1036619', '1036630', '1036615', '1036625', '1073332', '1036624'] #'1036607', 
all_dices = []
