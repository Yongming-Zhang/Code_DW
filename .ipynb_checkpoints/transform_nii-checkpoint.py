...
path = '/mnt/BrainDataNFS/dataset/ccta/db_update/others/crop_cardiac_zoom/image/'
transformed_path = '/mnt/BrainDataNFS/dataset/ccta/db_update/others/crop_cardiac_zoom/transformed_vessel_20201110/'
#img = itk.imread(path)
#view(img)
